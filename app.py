...
file_id = "1nVn9DMoMUEt_csgDNTA-JOy5SWVN5U1X"
...
# Grad-CAM function
# =====================
def grad_cam(img_array, model, last_conv="conv5_block3_out", alpha=0.4):
...
def index():
    if request.method == "POST":
        ...
        return render_template("index.html", label=label, prob=prob, filename=filename)
